            ...
            { _, observer, _, _, _ in
                ...
                DispatchQueue.main.async {
                    ...
                    handler.finishBroadcastWithError(NSError(
                        domain: "com.voiceping.transcribe",
                        code: 0,
                        userInfo: [NSLocalizedFailureReasonErrorKey: "Recording stopped by user"]
                    ))
                }
            },
            "com.voiceping.transcribe.stopBroadcast" as CFString,
            nil,
            .deliverImmediately
        )
    }
    ...
    override func processSampleBuffer(_ sampleBuffer: CMSampleBuffer, with sampleBufferType: RPSampleBufferType) {
        ...
        case .audioApp:
            ...
            if isFloat && bytesPerSample == 4 {
                // Float32 — handle big-endian if needed
                dataPointer.withMemoryRebound(to: UInt32.self, capacity: sampleCount * channelCount) { rawPtr in
                    // Helper: read a Float32 sample, byte-swapping if big-endian
                ...
                // Int16 PCM — ReplayKit on iOS typically delivers big-endian Int16
